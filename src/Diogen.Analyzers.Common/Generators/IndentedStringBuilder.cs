...
public class IndentedStringBuilder
{
    ...
    /// <summary>
    ///     Appends the current indent and then the given object to the string being built.
    /// </summary>
    /// <param name="value">The string to append.</param>
    /// <returns>This builder so that additional calls can be chained.</returns>
    ...
    public virtual IndentedStringBuilder Append([InterpolatedStringHandlerArgument("")] ref AppendHandler handler)
    {
        return this;
    }
    ...
    public virtual IndentedStringBuilder AppendLine([InterpolatedStringHandlerArgument("")] ref AppendHandler handler)
    {
        AppendLine();
        return this;
    }
    ...
    public ref struct AppendHandler
    {
        private readonly IndentedStringBuilder _builder;

        public AppendHandler(int literalLength, int formattedCount, IndentedStringBuilder builder)
        {
            _builder = builder;
            builder.DoIndent();
        }
        ...
        public void AppendFormatted(IEnumerable<string> formatted)
        {
            _builder.Append(formatted);
        }

        public void AppendFormatted(IEnumerable<char> formatted)
        {
            _builder.Append(formatted);
        }

        public void AppendFormatted(object formatted)
        {
            _builder.Append(formatted);
        }

        public void AppendFormatted(ReadOnlySpan<char> formatted)
        {
            _builder.Append(formatted);
        }
    }
