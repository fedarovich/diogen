...
using Diogen.Extensions.DependencyInjection.Analyzers.Generators.AggregatedServices;
...
{
    private static readonly string ToolName = typeof(AggregatedServicesGenerator).FullName!;
    private static readonly string Version = typeof(AggregatedServicesGenerator).Assembly.GetName().Version!.ToString();
